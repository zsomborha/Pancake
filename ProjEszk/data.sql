...
INSERT INTO QUESTION (ID, QUESTION_STRING, CORRECT_ANSWER, INCORRECT_ANSWER_1, INCORRECT_ANSWER_2, INCORRECT_ANSWER_3) 
VALUES (6, 'Miből állítjuk elő Grignard reagenst?', 'R-X + Mg', 'Éterből', 'Borból', 'Antianyagból');
INSERT INTO QUESTION (ID, QUESTION_STRING, CORRECT_ANSWER, INCORRECT_ANSWER_1, INCORRECT_ANSWER_2, INCORRECT_ANSWER_3) 
VALUES (7, 'Milyen diszperziós kolloid a majonéz?', 'Emulzió', 'Aeroszol', 'Szol', 'Gél');
INSERT INTO QUESTION (ID, QUESTION_STRING, CORRECT_ANSWER, INCORRECT_ANSWER_1, INCORRECT_ANSWER_2, INCORRECT_ANSWER_3) 
VALUES (8, 'Mit használunk egy észter elszappanosítására?', 'Nátrium-hidroxidot', 'Szappant', 'Lanolint', 'Csontszenet');